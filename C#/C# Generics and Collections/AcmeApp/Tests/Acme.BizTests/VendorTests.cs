...
namespace Acme.Biz.Tests
{
    ...
    public class VendorTests
    {
        ...
        public void SendEmailTest()
        {
            ...
            var vendors = vendorsCollection.ToList(); // cast ICollection<Vendor> to List<Vendor>
        ...
        public void SendEmailTestDictionary()
        {
            ...
            var vendors = vendorsCollection.ToDictionary(v => v.CompanyName); // cast ICollection<Vendor> to Dictionary<string, Vendor>
        ...
        {
            var vendorRespository = new VendorRepository();
            var vendorsCollection = vendorRespository.Retrieve();
            var expected = new List<string>()
        {
            "Message sent: Important message for: ABC Corp",
            "Message sent: Important message for: XYZ Inc"
        };
            var vendors = vendorsCollection.ToArray(); // Cast ICollection<Vendor> to Array<Vendor>
